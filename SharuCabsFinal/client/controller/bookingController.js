angular.module('Sharucabs').controller('bookingController', function($scope, $http,$window,$cookies,$mdDialog) {
  this.$window=$window;
  $scope.Booking={};
var socket=io();
tariff={};
...
$http.get('/getCabDetail/'+data.msg.driver.MobileNo).then(function(response) {
    ...
    window.destination="";
              ...
              input = document.getElementById("inpick");
              destination=document.getElementById("indest");
...
document.getElementById("inpick").value=results[1].formatted_address.toString();
...
console.log(currentTime);
     input="";
     destination="";
     input = document.getElementById("inpick").value;
