angular.module('Sharucabs').controller('addCabController', function($scope,$http,$mdDialog) {
...
//alert('Submit the form first and then upload the photo');
    ...
    $http.get('/getCabDetail').then(function(response) {
      console.log('qwfrgt executed');
